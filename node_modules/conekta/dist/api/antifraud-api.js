...
const AntifraudApiAxiosParamCreator = function (configuration) {
    return {
         ...
         */
        createRuleBlacklist: (createRiskRulesData_1, acceptLanguage_1, ...args_1) => __awaiter(this, [createRiskRulesData_1, acceptLanguage_1, ...args_1], void 0, function* (createRiskRulesData, acceptLanguage, options = {}) {
         ...
         * @throws {RequiredError}
         */
        createRuleWhitelist: (acceptLanguage_2, createRiskRulesData_2, ...args_2) => __awaiter(this, [acceptLanguage_2, createRiskRulesData_2, ...args_2], void 0, function* (acceptLanguage, createRiskRulesData, options = {}) {
         ...
         * @throws {RequiredError}
         */
        deleteRuleBlacklist: (id_1, acceptLanguage_3, xChildCompanyId_1, ...args_3) => __awaiter(this, [id_1, acceptLanguage_3, xChildCompanyId_1, ...args_3], void 0, function* (id, acceptLanguage, xChildCompanyId, options = {}) {
         ...
         * @throws {RequiredError}
         */
        deleteRuleWhitelist: (id_2, acceptLanguage_4, xChildCompanyId_2, ...args_4) => __awaiter(this, [id_2, acceptLanguage_4, xChildCompanyId_2, ...args_4], void 0, function* (id, acceptLanguage, xChildCompanyId, options = {}) {
            // verify required parameter 'id' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        getRuleBlacklist: (acceptLanguage_5, ...args_5) => __awaiter(this, [acceptLanguage_5, ...args_5], void 0, function* (acceptLanguage, options = {}) {
            const localVarPath = `/antifraud/blacklists`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, common_1.DUMMY_BASE_URL);
            let baseOptions;
         ...
         * @throws {RequiredError}
         */
        getRuleWhitelist: (acceptLanguage_6, ...args_6) => __awaiter(this, [acceptLanguage_6, ...args_6], void 0, function* (acceptLanguage, options = {}) {
            const localVarPath = `/antifraud/whitelists`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, common_1.DUMMY_BASE_URL);
            let baseOptions;
